...
public class RoundedTextField_Dinh extends JTextField implements Serializable {
    private int cornerRadius;
    private int padding;
    private Color borderColor;

    public RoundedTextField_Dinh() {
        this(15, 10, Color.GRAY); // Default values
    }

    public RoundedTextField_Dinh(int cornerRadius, int padding, Color borderColor) {
        super();
