...
public class RoundTextField_Linh extends JTextField implements Serializable {
    private int cornerRadius;
    private int padding;
    private Color borderColor;

    public RoundTextField_Linh() {
        this(15, 10, Color.GRAY); // Default values
    }

    public RoundTextField_Linh(int cornerRadius, int padding, Color borderColor) {
        super();
