...
public class RoundTextField_Kiet extends JTextField implements Serializable {
    private int cornerRadius;
    private int padding;
    private Color borderColor;

    public RoundTextField_Kiet() {
        this(15, 10, Color.GRAY); // Default values
    }

    public RoundTextField_Kiet(int cornerRadius, int padding, Color borderColor) {
        super();
