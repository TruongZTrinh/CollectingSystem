 ...
 * @author Asus
 */
public class Doiten_project extends javax.swing.JPanel {
    private int project_id;
    private ProjectIcon projectIcon; // Tham chiếu đến ProjectIcon

    public Doiten_project(int project_id, ProjectIcon projectIcon) {
    ...
    try {
        ...
        if (conn == null) {
            javax.swing.JOptionPane.showMessageDialog(this, "Không thể kết nối tới cơ sở dữ liệu!", "Lỗi", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        pstmt.setInt(2, project_id); // Giả sử bạn có phương thức getId() để lấy ID của biểu mẫu
        ...
        if (rowsUpdated > 0) {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Không tìm thấy biểu mẫu với ID: " + project_id + " để cập nhật!", "Lỗi", javax.swing.JOptionPane.WARNING_MESSAGE);
        }
    } catch (Exception e) {
        e.printStackTrace();
...
//            javax.swing.JOptionPane.showMessageDialog(this, "Đổi tên thành công!", "Thông báo", javax.swing.JOptionPane.INFORMATION_MESSAGE);
            ...
            projectIcon.setProjectName(newName);
